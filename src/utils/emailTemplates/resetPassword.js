export const resetPasswordTemplate = (link, fullName = "") => `
  <!DOCTYPE html>
  <html>
    <head>
      <meta charset="UTF-8" />
            ...
            <table width="500" cellpadding="0" cellspacing="0" 
              ...
              <tr>
                <td align="center" style="padding:20px 0;">
                  <a href="${link}" 
                    style="background:#ff6b81; color:#fff; padding:12px 24px; text-decoration:none; border-radius:6px; font-size:14px;">
                    Reset Password
                  </a>
                </td>
              </tr>
